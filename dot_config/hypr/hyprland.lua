...
hl.bind("SHIFT + PRINT", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | tee " .. ss_dir .. "/" .. ss_name .. "." .. ss_ext .. " | wl-copy"))
hl.bind("CTRL + PRINT", hl.dsp.exec_cmd("pkill -INT wf-recorder || wf-recorder -g \"$(slurp)\" -f " .. sr_dir .. "/" .. ss_name .. ".mp4"))
...
hl.window_rule({
    name = "red-border-floating-focus",
    match = { float = true, focus = true },
    border_color = "rgb(ff0000)"
})

hl.window_rule({
    name = "red-border-floating-unfocus",
